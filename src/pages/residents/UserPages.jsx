...
{/* Page Header */} <div className="bg-white rounded-xl shadow-lg p-6 mb-6"> <h2 className="text-2xl font-bold text-gray-800">My Account</h2> <p className="text-gray-600 mt-1">Manage your account information</p> </div>
...
```
  ...
  <div className="bg-white rounded-xl shadow-lg overflow-hidden p-6">  
    <div className="flex items-center gap-6 mb-8">  
      ...
      <div>  
        <h3 className="text-xl font-bold text-gray-800">{myAccount.firstName} {myAccount.lastName}</h3>  
        <p className="text-gray-600">{myAccount.role.toUpperCase()}</p>  
        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border mt-2 ${getStatusBadge(myAccount.status)}`}>  
